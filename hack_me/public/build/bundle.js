...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*username*/ ctx[1] == "admin") return 0;
    		return 1;
    	}
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Whoa du hackade admin";
    			add_location(p, file, 24, 3, 506);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			current = true;
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*authenticated*/ ctx[3] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 19, 1, 298);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Username");
    			add_location(input0, file, 20, 1, 315);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			add_location(input1, file, 21, 1, 383);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 18, 0, 290);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*authenticated*/ ctx[3]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*authenticated*/ 8) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { name } = $$props;
    	let database = { admin: "bruh", test: "test" };
    	let username = "";
    	let password = "";
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*username, password*/ 6) {
    			{
    				$$invalidate(3, authenticated = username in database && database[username] == password);
    			}
    		}
    	};
